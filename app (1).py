...
# ==============================================================================
# ÁREA DO ÍCONE (IMPORTANTE!)
# ==============================================================================
# Cole o código GIGANTE do ícone aqui dentro das aspas abaixo
ICONE_PADRAO_BASE64 = """
...
def carregar_fonte_segura():
    ...
    if not os.path.exists(font_filename):
        try:
            ...
            # Se falhar (sem internet), infelizmente usa a padrão
            return ImageFont.load_default()
    
    # 2. Carrega a fonte com tamanho 70 (GRANDE)
    try:
...
def load_icon_from_base64(base64_string):
    ...
    if len(base64_string) < 100: return None
    try:
...
def gerar_vertical(logo_img, icon_pil):
    ...
    # --- AQUI ESTÁ A CORREÇÃO: USANDO A FONTE BAIXADA ---
    ...
    # Barra (Espessura 3 é fina e elegante se o texto for grande)
...
if uploaded_logos:
    ...
    if icon_pil is None: st.warning("⚠️ Ícone não carregado. Banners serão gerados sem ele.")
